  ...
  for (t in seq_along(idx)) {
    ...
    if (t == 1) {
      ...
      df$depression_latent[row] <-
        ...
        (beta_age_dep + beta_age_sex_dep * df$sex[row]) * (df$age[row] - 14) +
        beta_sex_dep * df$sex[row] +
        beta_ses_dep * df$ses[row] +
        beta_sleep_dep * df$sleep[row] +
        df$e_dep[row]
      ...
      df$anxiety_latent[row] <-
        ...
        (beta_age_anx + beta_age_sex_anx * df$sex[row]) * (df$age[row] - 14) +
        beta_sex_anx * df$sex[row] +
        beta_ses_anx * df$ses[row] +
        beta_sleep_anx * df$sleep[row] +
        df$e_anx[row]
