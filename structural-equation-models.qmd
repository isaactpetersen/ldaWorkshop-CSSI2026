...
longitudinalMI1 <- read.csv("./data/Bliese-Ployhard-2000-indicators-1.csv")
longitudinalMI2 <- read.csv("./data/Bliese-Ployhard-2000-indicators-2.csv")
longitudinalMI3 <- read.csv("./data/Bliese-Ployhard-2000-indicators-3.csv")
longitudinalMI4 <- read.csv("./data/Bliese-Ployhard-2000-indicators-4.csv")
```
...
For the longitudinal measurement invariance models, we will use simulated data from <https://mycourses.aalto.fi/mod/assign/view.php?id=1203047>.
As noted [here](https://mycourses.aalto.fi/mod/assign/view.php?id=1203047), "The data are in wide format where the variables are coded as [VARIABLE NAME][time index][indicator index]."

Questions:

- Which level of longitudinal measurement invariance holds for the `Bliese-Ployhard-2000-indicators-1.csv` dataset (saved in object `longitudinalMI1`)?
- Repeat the tests of longitudinal measurement invariance for the remaining datasets.
