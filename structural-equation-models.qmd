...
1. Does within-person change in anxiety predict within-person change in depression (and vice versa).
...
We can constrain the variances to be nonnegative.

```{r}
latentBasisGCMmodified_fit <- lavaan::sem(
  latentBasisGCMmodified_syntax,
  data = mydata_wide,
  missing = "ML",
  estimator = "MLR",
  meanstructure = TRUE,
