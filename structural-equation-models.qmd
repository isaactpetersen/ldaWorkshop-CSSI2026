...
In estimating linear growth curves of depression symptoms, this model fits random intercepts and slopes for subjects, `sex` as a time-invariant fixed-effect predictor of the intercepts and slopes, and `sleep` as a time-varying fixed-effect covariate of the manifest variables for depression symptoms.
...
In estimating quadratic growth curves of depression symptoms, this model fits random intercepts and random linear and quadratic slopes for subjects, `sex` as a time-invariant fixed-effect predictor of the intercepts and slopes, and `sleep` as a time-varying fixed-effect covariate of the manifest variables for depression symptoms.
...
In estimating latent basis growth curves of depression symptoms, this model fits random intercepts and slopes for subjects, `sex` as a time-invariant fixed-effect predictor of the intercepts and slopes, and `sleep` as a time-varying fixed-effect covariate of the manifest variables for depression symptoms.
...
In disaggregating within- and between-person effects, this model examines the within-person association of sleep, anxiety, and SES with depression, and simultaneously examines the between-person association of sleep, anxiety, and SES with depression.
